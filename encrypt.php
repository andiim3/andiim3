 ...
 * 
 * 
 *       $hunter = new HunterObfuscator($html, true);
 *       $hunter->addDomainName('google.com,bing.com'); //the generated code will work only on google.com and bing.com
 *       $hunter->setExpiration('+10 day'); //Expires after 10 days
 *       $html = $hunter->Obfuscate();
